...
- Current ordered passes are:
  `terrain_tiles -> decorative_buildings -> fountain/plaza -> power_grid_underlay -> transit_underlay -> agent_buildings -> city_life_overlay -> particles`.
...
## Implementation Guidance for Subtasks 2-5
