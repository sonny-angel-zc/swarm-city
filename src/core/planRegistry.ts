...
const DOCS_SEED: PlanDocument[] = [
  ...
  },
  {
    ...
    title: 'Budget Alert Requirements and Threshold Rules (SWA-73 Subtask 1/8)',
    path: 'docs/testing/budget-alert-requirements-swa-73-subtask-1.md',
    category: 'reference',
    track: 'foundation',
    updatedAt: '2026-03-03',
    summary: 'Defines warning/critical threshold behavior, defaults, scope precedence, reset logic, notification channels, and acceptance criteria for SWA-73.',
    tags: ['budget', 'alerts', 'cost-tracking', 'thresholds', 'swa-73', 'requirements', 'research'],
    content: [
      'SWA-73 subtask 1/8 defines budget alert behavior and threshold rules before implementation expansion.',
      '- Locks default threshold contract at 50/75/90/100 percent with warning vs critical severity split.',
      '- Defines scope precedence for alerts: project+user override, then project default, then workspace default.',
